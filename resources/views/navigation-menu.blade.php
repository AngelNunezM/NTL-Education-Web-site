                ...
                <div class="ml-3 relative">
                    @auth
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{route('Cursos.MyShow', Auth::user()->id)}}" :active="request()->routeIs('Cursos.MyShow')">
                                {{ __('Mis Cursos') }}
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link href="{{route('Cursos.MyShow', Auth::user()->id)}}" :active="request()->routeIs('Cursos.MyShow')">
                    {{ __('Mis Cursos') }}
                </x-responsive-nav-link>
